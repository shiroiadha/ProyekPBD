object FDM: TFDM
  ...
  object akun_zq: TZQuery
    ...
    Active = True
    SQL.Strings = (
      'SELECT * FROM akun ORDER BY username ASC')
    Params = <>
    Left = 360
    Top = 16
  ...
  object mapel_ds: TDataSource
    DataSet = mapel_zq
    Left = 424
    Top = 80
  end
  object mapel_zq: TZQuery
    Connection = FLogin.con1
    Active = True
    SQL.Strings = (
  ...
  object tahun_ds: TDataSource
    DataSet = tahun_zq
    Left = 488
    Top = 80
  end
  object tahun_zq: TZQuery
    Connection = FLogin.con1
    Active = True
    SQL.Strings = (
      
        'SELECT * FROM tahunajaran ORDER BY tahun_mulai, tahun_selesai DE' +
        'SC')
    Params = <>
    Left = 488
    Top = 16
  end
  object ruang_ds: TDataSource
    DataSet = ruang_zq
    Left = 552
    Top = 80
  end
  object ruang_zq: TZQuery
    Connection = FLogin.con1
    Active = True
    SQL.Strings = (
      'SELECT * FROM ruangkelas ORDER BY nama_ruang ASC')
    Params = <>
    Left = 552
    Top = 16
  end
  object guru_smdbfn: TSMDBFindDialog
  ...
  object guru_smdbft: TSMDBFilterDialog
  ...
  object guru_mxdbg: TmxDBGridExport
    ...
    Version = '2.37'
    DBGrid = FDatabases.guru_smdbg
    Left = 168
    Top = 280
  end
  object siswa_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = siswa_ds
    FindOption = []
  ...
  object siswa_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = siswa_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object siswa_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = FDatabases.siswa_smdbg
    Left = 232
    Top = 280
  end
  object kls_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = kls_ds
    FindOption = []
  ...
  object kls_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = kls_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object kls_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = FDatabases.kls_smdbg
    Left = 296
    Top = 280
  end
  object akun_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = akun_ds
    FindOption = []
  ...
  object akun_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = akun_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object akun_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = FDatabases.akun_smdbg
    Left = 360
    Top = 280
  end
  object mapel_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = mapel_ds
    FindOption = []
  ...
  object mapel_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = mapel_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object mapel_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = FDatabases.mapel_smdbg
    Left = 424
    Top = 280
  end
  object tahun_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = tahun_ds
    FindOption = []
  ...
  object tahun_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = tahun_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object tahun_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
    ...
    Options = [xoClipboardMessage, xoFooterLine, xoHeaderLine, xoShowExportDate, xoShowHeader, xoShowProgress, xoUseAlignments]
    Version = '2.37'
    DBGrid = FDatabases.tahun_smdbg
    Left = 488
    Top = 280
  end
  object ruang_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = ruang_ds
    FindOption = []
  ...
  object ruang_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = ruang_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object ruang_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
  ...
  object jdwl_ds: TDataSource
    DataSet = jdwl_zq
    Left = 608
    Top = 80
  end
  object jdwl_zq: TZQuery
    Connection = FLogin.con1
    Active = True
    SQL.Strings = (
      'SELECT * FROM jadwal')
  ...
  object jdwl_smdbfn: TSMDBFindDialog
    Caption = 'Record search'
    ShowDialog = True
    DataSource = jdwl_ds
    FindOption = []
  ...
  object jdwl_smdbft: TSMDBFilterDialog
    Caption = 'Filter setup dialog'
    Dataset = jdwl_zq
    FilterMode = fmFilterDataset
    WildCard = '%'
  ...
  object jdwl_mxdbg: TmxDBGridExport
    DateFormat = 'dd/MM/yyyy'
    TimeFormat = 'hh:mm'
    DateTimeFormat = 'hh:mm dd/MM/yyyy'
    ExportType = xtExcel
